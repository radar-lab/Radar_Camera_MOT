...
from nets.CSPdarknet53 import Mish, DarknetConv2D, darknet_body, compose
...
if __name__ == "__main__":
    ...
    full_model_path = "./logs/img_classification_final_model.h5"
...
###############################  Test  #########################################
    ...
    ## create dataset 
    test_dataset = Dataset_BatchGet(input_shape, paths[(num_train+num_val):], labels[(num_train+num_val):], batch_size, num_classes, rand_flag=True, new_size=[416,416,3])
    ...
    for i in sample_indices:
        ...
        image_path = paths[(num_train + num_val):][i]
